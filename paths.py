...
if LANGUAGE == 'EN':
    ...
    LIST_LANDS = [
        ...
        'Domínio de Golens', 'Campo de Dragões', 'Dragão do Mar', 'Estrada Desolada', 'Domínio Draconiano',
        'Distúrbio Místico', 'Cidade Ghabul', 'Cidade Dragão', 'Porto Draconiano', 'Ilha dos Anciões',
        'Floresta dos Elfos Silvestres', 'Terras de Ninguém', 'Deserto dos Mortos', 'Portão do Inferno',
        'Montanhas de Dragões', 'Cidade Ymir', 'Área dos Lizardmans', 'Cidade Amaldiçoada', 'Horda de Goblins',
        'Horda Orcs', 'Montanhas dos Elfos Cinzentos', 'Esconderijo dos Gnomos', 'Vale Tempestade', 'Invasão Fomorian',
        'Cidade de Aretuza', 'Estrada do Norte', 'Floresta dos Druidas', 'Guilda dos Magos', 'Túneis dos Elfos Negros',
        'Zona Mítica', 'Mar do Norte', 'Guilda das Bruxas', 'Aesir', 'Guilda das Sombras', 'Guilda  dos Guerreiros',
